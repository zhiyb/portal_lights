...
ASSERT(_stext + SIZEOF(.text) < ORIGIN(LOAD) + LENGTH(LOAD), "
ERROR(cortex-m-rt): The .text section must be placed inside the FLASH memory.
Set _stext to an address smaller than 'ORIGIN(LOAD) + LENGTH(LOAD)'");
